...
// GetStackInfoString: toma el bloque opaco y lo transforma a texto resolviendo s�mbolos con dladdr+addr2line
...
begin
  ...
  begin
    ...
    // Si dladdr puede identificar la librer�a/exe:
    ...
    begin
      ...
      // Primero intenta addr2line con direcci�n absoluta
      ...
      // Si fall�, intenta con direcci�n relativa (addr - base)
      ...
      // Si no resolvi� con addr2line, intenta usar el nombre de s�mbolo devuelto por dladdr
    ...
    begin
      // Si dladdr no ayud�, mostramos la direcci�n hex
...
// Inicializaci�n: asignar las proc pointers en Exception (como hac�as)
procedure  InitStackTraceExceptionHandling;
begin
  if (InitDone) then
   exit;
