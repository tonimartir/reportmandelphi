...
rem Reportman repo root holds rpfastserializer.pas and rpconf.inc.
set RPROOT=..\..
...
echo --------------------------------------------
%DCC32% -B -CC -E.\bin_x86 -U%RPROOT% -I%RPROOT% -NS%NS% test_fastserializer.dpr
if errorlevel 1 (
...
echo --------------------------------------------
%DCC64% -B -CC -E.\bin_x64 -U%RPROOT% -I%RPROOT% -NS%NS% test_fastserializer.dpr
if errorlevel 1 (
...
echo.
echo Build OK.
echo   bin_x86\test_fastserializer.exe
echo   bin_x64\test_fastserializer.exe
echo.
endlocal
